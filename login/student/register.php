    ...
    <div class="container-fluid my-5" style="">
        <div class="w-100">
            <div class="card w-100 h-100 mx-auto border-1" style="min-width: 300px; max-width:calc(0.5 * 768px); min-height: 20rem;">
                ...
                <h5 class="card-header mt-2 border-0 bg-transparent">Create Account</h5>
                    ...
                    <form class="form" id="login_form">
                        ...
                        <div class="input-group has-validation mb-3">
                            <div class="form-floating ">
                                <input id="id_field" class="form-control" name="studID_field" type="text" placeholder="ID" autocomplete="false" />
                                <label for="id_field">Student ID</label>
                            </div>
                        </div>
                        <div class="input-group has-validation mb-3">
                            <div class="form-floating ">
                                <input id="email_field" class="form-control" name="email_field" type="email" placeholder="Email" autocomplete="false" />
                        ...
                        <div class="input-group has-validation mb-3">
                            <div class="form-floating ">
                                <input id="fn_field" class="form-control" name="fn_field" type="text" placeholder="Firstname" autocomplete="false" />
                                <label for="fn_field">First</label>
                            </div>
                            <div class="form-floating">
                                <input id="m_field" class="form-control rounded-0" name="m_field" type="text" placeholder="Middlename" autocomplete="false" />
                                <label for="m_field">Middle</label>
                            </div>
                            <div class="form-floating ">
                                <input id="ln_field" class="form-control " name="ln_field" type="text" placeholder="Lastname" autocomplete="false" />
                                <label for="ln_field">Last</label>
                            </div>
                        </div>
                        <div class="input-group has-validation mb-4">
                            <div class="form-floating">
                                <input id="password_field" class="form-control" name="password_field" type="password" placeholder="Password" autocomplete="false"/>
                                <label for="password_field">Password</label>
                            </div>
                        </div>
                        <div class="container d-flex justify-content-center" >
                            <button class="btn btn-primary p-2" type="submit" form="login_form" style="width: 10rem;">Sign up</button>
                        </div>
                    </form>
